...
let db, playersDB, adminsDB, bansDB, statsDB, playerInventoryDB; // Var for DB
...
haxball.then(async (HBInit) => {
	...
	async function run() {
		...
		db = debugMode ? client.db("HaxZoneTEST") : client.db("HaxZoneEvent");
		...
		statstournamentDB = db.collection("PlayersStatsTournament");
	...
	/* CONFIG ROOM */
	const roomName = debugFilter ? '🔷️ • HaxZone • 🏆 Tournament 1 🎖️🔷' : '🔷️ • HaxZone • 🏆 Tournament 1 🎖️🔷';
	const maxPlayers = 22;
	const roomPublic = debugMode ? false : true;
	const geo = { "code": "IT", "lat": 42.5176066, "lon": 12.5154288 }
	
	// Variabile globale per tracciare la modalità torneo
	...
	let goalDifferenceLimit = 10;
	let previousBallPositionX = 0;
	let lastActionInitialScore = null;
	let mostraLastActionMessaggio = true;
	...
	/* STADI */
	let ST4v4 = '{"name":"StadiumHaxZoneSword(4v4)","width":790,"height":370,"spawnDistance":450,"bg":{"type":"none","width":750,"height":340,"kickOffRadius":100,"cornerRadius":0,"color":"505050"},"vertexes":[{"x":-700,"y":320,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":30,"curve":0,"color":"C22F43"},{"x":-700,"y":100,"trait":"ballArea","bias":-30,"color":"008FBA"},{"x":-700,"y":-100,"trait":"ballArea","bias":-30,"color":"008FBA"},{"x":-700,"y":-320,"cMask":["wall"],"cGroup":["wall"],"trait":"ballArea","bias":-30,"curve":0,"color":"C22F43"},{"x":700,"y":320,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","color":"597AA2","bias":30,"curve":0},{"x":700,"y":100,"cGroup":["wall"],"trait":"ballArea","bias":30,"color":"910000"},{"x":700,"y":-100,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":30,"color":"910000"},{"x":700,"y":-320,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","color":"597AA2","bias":30,"curve":0},{"x":0,"y":70,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"C22F43","vis":true,"curve":-180},{"x":0,"y":-70,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"C22F43","vis":true,"curve":-180},{"x":0,"y":-320,"bCoef":1,"cMask":["wall"],"cGroup":["wall"],"color":"C22F43","curve":0},{"x":0,"y":320,"bCoef":1,"cMask":["wall"],"cGroup":["wall"],"color":"C22F43","curve":0},{"x":-700,"y":-320,"bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":-30,"vis":false},{"x":700,"y":-320,"bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":-30,"vis":false},{"x":-700,"y":320,"bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":30,"vis":false,"curve":0},{"x":700,"y":320,"bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":30,"vis":false,"curve":0},{"x":0,"y":-320,"bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","color":"C22F43","vis":true,"curve":0},{"x":0,"y":-320,"trait":"kickOffBarrier","curve":0},{"x":0,"y":-70,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"C22F43","vis":true,"curve":0},{"x":0,"y":-320,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"C22F43","vis":true,"curve":0},{"x":375,"y":320,"bCoef":1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea","color":"597AA2","vis":true},{"x":375,"y":-320,"bCoef":1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea","color":"597AA2","vis":true},{"x":375,"y":80,"cMask":["wall"],"cGroup":["wall"],"trait":"ballArea","curve":140},{"x":375,"y":-80,"cMask":["wall"],"cGroup":["wall"],"trait":"ballArea","curve":140},{"x":-375,"y":-320,"bCoef":1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea","color":"C22F43"},{"x":-375,"y":320,"bCoef":1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea","color":"C22F43"},{"x":-375,"y":80,"cMask":["wall"],"cGroup":["wall"],"trait":"ballArea","curve":-140,"color":"C22F43"},{"x":-375,"y":-80,"cMask":["wall"],"cGroup":["wall"],"trait":"ballArea","curve":-140,"color":"C22F43"},{"x":0,"y":70,"trait":"kickOffBarrier","curve":0},{"x":0,"y":320,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"C22F43","vis":true,"curve":0},{"x":0,"y":-320,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"x":0,"y":-350,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"x":0,"y":350,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"x":0,"y":320,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"x":-375,"y":-320,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"x":-375,"y":-350,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"x":375,"y":-320,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"x":375,"y":-350,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"x":375,"y":-320,"bCoef":0.1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea"},{"x":375,"y":-350,"bCoef":0.1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea"},{"x":375,"y":350,"bCoef":0.1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea","curve":0},{"x":375,"y":320,"bCoef":0.1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea","curve":0},{"x":-375,"y":320,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea","curve":0},{"x":-375,"y":350,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea","curve":0}],"segments":[{"v0":0,"v1":1,"trait":"ballArea","bias":-30,"x":-700},{"v0":2,"v1":3,"trait":"ballArea","bias":-30,"x":-700},{"v0":4,"v1":5,"cGroup":["wall"],"trait":"ballArea","bias":30,"x":700},{"v0":6,"v1":7,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":30,"x":700},{"v0":8,"v1":9,"curve":180,"vis":true,"color":"C22F43","cGroup":["blueKO"],"trait":"kickOffBarrier"},{"v0":8,"v1":9,"curve":-180,"vis":true,"color":"597AA2","cGroup":["redKO"],"trait":"kickOffBarrier"},{"v0":3,"v1":0,"curve":0,"vis":true,"color":"C22F43","cMask":["wall"],"cGroup":["wall"]},{"v0":0,"v1":11,"curve":0,"vis":true,"color":"C22F43","cMask":["wall"],"cGroup":["wall"]},{"v0":11,"v1":4,"curve":0,"vis":true,"color":"597AA2","cMask":["wall"],"cGroup":["wall"],"y":340},{"v0":4,"v1":7,"curve":0,"vis":true,"color":"597AA2","cMask":["wall"],"cGroup":["wall"],"x":750},{"v0":3,"v1":10,"curve":0,"vis":true,"color":"C22F43","cMask":["wall"],"cGroup":["wall"],"y":-340},{"v0":7,"v1":10,"curve":0,"vis":true,"color":"597AA2","cMask":["wall"],"cGroup":["wall"],"y":-340},{"v0":10,"v1":9,"curve":0,"vis":true,"color":"C22F43","cMask":["wall"],"cGroup":["wall"]},{"v0":8,"v1":11,"curve":0,"vis":true,"color":"597AA2","cMask":["wall"],"cGroup":["wall"]},{"v0":12,"v1":13,"curve":0,"vis":false,"color":"C22F43","bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":-30},{"v0":14,"v1":15,"curve":0,"vis":false,"color":"C22F43","bCoef":1,"cMask":["ball"],"cGroup":["wall"],"trait":"ballArea","bias":30},{"v0":17,"v1":18,"curve":0,"trait":"kickOffBarrier","y":-100},{"v0":20,"v1":21,"vis":true,"color":"597AA2","bCoef":1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea"},{"v0":22,"v1":23,"curve":140,"vis":true,"color":"597AA2","cMask":["wall"],"cGroup":["wall"],"trait":"ballArea"},{"v0":24,"v1":25,"vis":true,"color":"C22F43","bCoef":1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"v0":26,"v1":27,"curve":-140,"vis":true,"color":"C22F43","cMask":["wall"],"cGroup":["wall"],"trait":"ballArea","x":-375},{"v0":28,"v1":29,"curve":0,"trait":"kickOffBarrier","y":-100},{"v0":30,"v1":31,"curve":0,"vis":false,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":32,"v1":33,"curve":0,"vis":false,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":34,"v1":35,"curve":0,"vis":false,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"v0":36,"v1":37,"curve":0,"vis":false,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"},{"v0":38,"v1":39,"curve":0,"vis":false,"bCoef":0.1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea"},{"v0":40,"v1":41,"curve":0,"vis":false,"bCoef":0.1,"cMask":["c1"],"cGroup":["wall"],"trait":"ballArea"},{"v0":42,"v1":43,"curve":0,"vis":false,"bCoef":0.1,"cMask":["c0"],"cGroup":["wall"],"trait":"ballArea"}],"goals":[{"p0":[-710,100],"p1":[-710,-100],"team":"red"},{"p0":[710,100],"p1":[710,-100],"team":"blue"}],"discs":[{"pos":[-700,-100],"color":"B80038","trait":"goalPost"},{"radius":4,"invMass":0,"pos":[-714,-100],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-723,-100],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-732,-100],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-741,-100],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-95],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-85],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-75],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-65],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-55],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-45],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-35],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-25],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-15],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,-5],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,5],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,15],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,25],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,35],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,45],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,55],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,65],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,75],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,85],"color":"B80038"},{"radius":4,"invMass":1,"pos":[-749,95],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-741,100],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-732,100],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-723,100],"color":"B80038"},{"radius":4,"invMass":0,"pos":[-714,100],"color":"B80038"},{"pos":[-700,100],"color":"B80038","trait":"goalPost"},{"pos":[700,-100],"color":"80B7F7","trait":"goalPost"},{"radius":4,"invMass":0,"pos":[714,-100],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[723,-100],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[732,-100],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[741,-100],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-95],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-85],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-75],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-65],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-55],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-45],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-35],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-25],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-15],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,-5],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,5],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,15],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,25],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,35],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,45],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,55],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,65],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,75],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,85],"color":"80B7F7"},{"radius":4,"invMass":1,"pos":[749,95],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[741,100],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[732,100],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[723,100],"color":"80B7F7"},{"radius":4,"invMass":0,"pos":[714,100],"color":"80B7F7"},{"pos":[700,100],"color":"80B7F7","trait":"goalPost"}],"planes":[{"normal":[0,-1],"dist":-350,"bCoef":0.1},{"normal":[0,1],"dist":-350,"bCoef":0.1},{"normal":[1,0],"dist":-765,"bCoef":0.1},{"normal":[-1,0],"dist":-765,"bCoef":0.1}],"traits":{"ballArea":{"vis":false,"bCoef":1,"cMask":["ball"]},"goalPost":{"radius":8,"invMass":0,"bCoef":0.5},"goalNet":{"vis":true,"bCoef":0.1,"cMask":["ball"]},"kickOffBarrier":{"vis":false,"bCoef":0.1,"cGroup":["redKO","blueKO"],"cMask":["red","blue"]},"jr":{"strength":0.1,"color":"B80038"},"jb":{"strength":0.1,"color":"80B7F7"}},"joints":[{"d0":1,"d1":2,"length":null,"trait":"jr"},{"d0":2,"d1":3,"length":null,"trait":"jr"},{"d0":3,"d1":4,"length":null,"trait":"jr"},{"d0":4,"d1":5,"length":null,"trait":"jr"},{"d0":5,"d1":6,"length":null,"trait":"jr"},{"d0":6,"d1":7,"length":null,"trait":"jr"},{"d0":7,"d1":8,"length":null,"trait":"jr"},{"d0":8,"d1":9,"length":null,"trait":"jr"},{"d0":9,"d1":10,"length":null,"trait":"jr"},{"d0":10,"d1":11,"length":null,"trait":"jr"},{"d0":11,"d1":12,"length":null,"trait":"jr"},{"d0":12,"d1":13,"length":null,"trait":"jr"},{"d0":13,"d1":14,"length":null,"trait":"jr"},{"d0":14,"d1":15,"length":null,"trait":"jr"},{"d0":15,"d1":16,"length":null,"trait":"jr"},{"d0":16,"d1":17,"length":null,"trait":"jr"},{"d0":17,"d1":18,"length":null,"trait":"jr"},{"d0":18,"d1":19,"length":null,"trait":"jr"},{"d0":19,"d1":20,"length":null,"trait":"jr"},{"d0":20,"d1":21,"length":null,"trait":"jr"},{"d0":21,"d1":22,"length":null,"trait":"jr"},{"d0":22,"d1":23,"length":null,"trait":"jr"},{"d0":23,"d1":24,"length":null,"trait":"jr"},{"d0":24,"d1":25,"length":null,"trait":"jr"},{"d0":25,"d1":26,"length":null,"trait":"jr"},{"d0":26,"d1":27,"length":null,"trait":"jr"},{"d0":27,"d1":28,"length":null,"trait":"jr"},{"d0":28,"d1":29,"length":null,"trait":"jr"},{"d0":29,"d1":30,"length":null,"trait":"jr"},{"d0":31,"d1":32,"length":null,"trait":"jr"},{"d0":32,"d1":33,"trait":"jb"},{"d0":33,"d1":34,"trait":"jb"},{"d0":34,"d1":35,"trait":"jb"},{"d0":35,"d1":36,"trait":"jb"},{"d0":36,"d1":37,"trait":"jb"},{"d0":37,"d1":38,"trait":"jb"},{"d0":38,"d1":39,"trait":"jb"},{"d0":39,"d1":40,"trait":"jb","invMass":1},{"d0":40,"d1":41,"trait":"jb","invMass":1},{"d0":41,"d1":42,"trait":"jb","invMass":1},{"d0":42,"d1":43,"trait":"jb","invMass":1},{"d0":43,"d1":44,"trait":"jb","invMass":1},{"d0":44,"d1":45,"trait":"jb","invMass":1},{"d0":45,"d1":46,"trait":"jb","invMass":1},{"d0":46,"d1":47,"trait":"jb","invMass":1},{"d0":47,"d1":48,"trait":"jb","invMass":1},{"d0":48,"d1":49,"trait":"jb","invMass":1},{"d0":49,"d1":50,"trait":"jb","invMass":1},{"d0":50,"d1":51,"trait":"jb","invMass":1},{"d0":51,"d1":52,"trait":"jb","invMass":1},{"d0":52,"d1":53,"trait":"jb","invMass":1},{"d0":53,"d1":54,"trait":"jb"},{"d0":54,"d1":55,"trait":"jb"},{"d0":55,"d1":56,"trait":"jb"},{"d0":56,"d1":57,"trait":"jb"},{"d0":57,"d1":58,"trait":"jb"},{"d0":58,"d1":59,"trait":"jb"},{"d0":59,"d1":60,"trait":"jb"}],"playerPhysics":{"acceleration":0.11,"kickingAcceleration":0.1,"kickStrength":7,"radius":15,"bCoef":0.5,"invMass":0.5,"damping":0.96,"cGroup":["red","blue"],"gravity":[0,0],"kickingDamping":0.96,"kickback":0},"kickOffReset":"full","canBeStored":false,"ballPhysics":{"color":"CCCCCC","radius":10,"bCoef":0.5,"cMask":["all"],"damping":0.99,"invMass":1,"gravity":[0,0],"cGroup":["ball"]},"cameraWidth":0,"cameraHeight":0,"maxViewWidth":0,"cameraFollow":"ball","redSpawnPoints":[[-190,0],[-190,100],[-190,-100],[-340,0]],"blueSpawnPoints":[[190,0],[190,100],[190,-100],[340,0]]}';
	
	/* ------------------ */

	/* SEZIONE PER LINEA DIFENSIVA */
	/*var defLines = [-375, 375];*/
	...
	function adjustDefLines(player) {
		...
		var non_mfp_red;
		var non_mfp_blue;
		if (mfp_red != null && mfp_red != undefined) non_mfp_red = GetTeam(1).filter(p => p.id !== mfp_red.id);
		else non_mfp_red = GetTeam(1);
	 
		if (mfp_blue != null && mfp_blue != undefined) non_mfp_blue = GetTeam(2).filter(p => p.id !== mfp_blue.id);
		else non_mfp_blue = GetTeam(2);
	 
		if (mfp_red != null && mfp_red != undefined) {
		  if (room.getPlayerDiscProperties(mfp_red.id).cGroup === cf.red) {
			room.setPlayerDiscProperties(mfp_red.id, { cGroup: cf.red | cf.c0 });
		  }
		}
	 
		if (mfp_blue != null && mfp_blue != undefined) {
	  ...
	  function mostForwardPlayer(teamID) {
		...
		Sorted = sortByPosition(playersTeam);
		if (redTeamLength > 0 || blueTeamLength > 0) {
		  if (teamID === 1) {
			if (redTeam.length < 4) return null;
			return Sorted[redTeamLength - 1];
		  }
		  else if (teamID === 2) {
			if (blueTeamLength < 4) return null;
			return Sorted[0];
		  }
		}
	  }
	...
	const RoleEmoji = { GUEST: "🔒", PLAYER: "👤", VIP: "💎", EVENT: "🟨", HELPER: "⛑️", MODERATOR: "🪖", ADMIN: "🎩", FOUNDER: "🔒", DEVELOPER: "👨‍💻" , OWNER: "🔑" };
	...
	stadiumCommand(emptyPlayer, "!4v4");
	...
	let commands = {
		...
		setmatchtournament: {
			aliases: [],
			roles: [Role.HELPER],
			desc: `Questo comando ti permette di abilitare il salvataggio delle STATS nel database per i Tornei.`,
			function: setmatchtournamentCommand,
		},
		swap: {
			aliases: [],
			roles: [Role.EVENT, Role.HELPER],
		...
		stadio: {
			...
			desc: `Questo comando inserirà lo stadio da te scritto.
				ESEMPIO: !4v4    inserirà lo stadio scelto.`,
	...
	async function loginCommand(player, message) {
		...
		if (msgArray.length > 0 && msgArray[0].length > 0) {
			const anotherAccount = await playersDB.findOne({
				$and: [
					{ nickname: { $ne: player.name } },
					{ $or: [{ auth: player.auth }, { connect: player.conn }] },
					{ sharedAccounts: { $ne: player.name } }
				]
			});
				...
				if (thisPlayer != undefined) {
					if (!thisPlayer.isLogged) {
						bcrypt.compare(msgArray[0], thisPlayer.password, async (err, result) => {
							if (result) {
								// Se il ruolo del giocatore è inferiore a Role.EVENT, lo aggiorniamo
								if (thisPlayer.role < Role.EVENT) {
									await playersDB.updateOne(
										{ nickname: player.name },
										{ $set: { role: Role.EVENT } }  // Aggiorna il ruolo a Role.EVENT
									);
									room.sendAnnouncement(`${player.name}, sei stato aggiornato al ruolo Evento!`, player.id, successColor, 'bold', HaxNotification.CHAT);
								}
								await logPlayer(player, null, false); // Procedi con il login
							} else {
								room.sendAnnouncement(`Password errata, riprova o usa il comando !resetpassword per cambiare password!`, player.id, errorColor, 'bold', HaxNotification.CHAT);
							}
						});
					} else {
						msg = 'Sei già connesso!';
					}
				} else {
					msg = `Questo nickname non è ancora registrato. Puoi procedere con la registrazione tramite !register password.`;
				}
			}
		} else {
			msg = `Comando errato. Per ulteriori informazioni, digitare "!help login".`;
		}
	...
	async function helpCommand(player, message) {
		let msgArray = message.split(/ +/).slice(1);
		let fPla = fPar = fVip = fEve = fHel = fMod = fAdm = fFou = fDev = fOwn = false;
		if (msgArray.length == 0) {
			...
			for (const [key, value] of Object.entries(commands)) {
				...
				else if (value.roles == Role.EVENT) fEve = true;
			...
			if (player.role >= Role.EVENT && fEve) {
				commandString += `Event commands :\n`;
				for (const [key, value] of Object.entries(commands)) {
					if (value.desc && value.roles == Role.EVENT) commandString += ` !${key},`;
				}
				if (commandString.slice(commandString.length - 1) == ':')
					commandString += ` None,`;
				commandString = commandString.substring(0, commandString.length - 1) + '.\n\n';
	...
	function setmatchtournamentCommand(player, message) {
		isTournamentMode = !isTournamentMode; // Attiva/disattiva la modalità torneo
		console.log(`Modalità torneo ${isTournamentMode ? 'attivata' : 'disattivata'}`);
		room.sendAnnouncement(`⚔️ Modalità torneo ${isTournamentMode ? 'attivata' : 'disattivata'}!`, null, 0xFFFF00, "bold", 2);
	}
	...
	function stadiumCommand(player, message) {
		...
		if (gameState == State.STOP) {
			...
			else if (['!4v4'].includes(msgArray[0].toLowerCase())) {
				room.setCustomStadium(ST4v4);
				currentStadium = '4v4';
			} else {
				room.sendAnnouncement(
	...
	async function setRoleCommand(player, message) {
		try {
			...
			// Aggiornare ruolo e stringa del ruolo nei database playersDB e adminsDB
			await playersDB.updateOne(
	...
	function checkTime() {
		...
		// Controlla il tempo e assicura che l'ultima azione sia in corso
		if (!isLastAction && Math.abs(scores.time - scores.timeLimit) <= 0.01 && scores.timeLimit != 0 && playSituation == Situation.PLAY) {
		...
		// Controllo per evitare che la partita si fermi se siamo nell'ultima azione
		if (!isLastAction && Math.abs(scores.time - drawTimeLimit * 60 - scores.timeLimit) <= 0.01 && scores.timeLimit != 0) {
			if (!checkTimeVariable) {
				checkTimeVariable = true;
				setTimeout(() => {
					checkTimeVariable = false;
	...
	function endGame(winner) {
		...
		if (scores.red === scores.blue) {
			room.sendAnnouncement("😐 La partita è finita in pareggio!", null, announcementColor, "bold", HaxNotification.CHAT);
		} else {
			room.sendAnnouncement(`✨ La squadra ${winner === Team.RED ? "Red" : "Blue"} ha vinto ${scores.red} - ${scores.blue}!`, null, winner === Team.RED ? redColor : blueColor, "bold", HaxNotification.CHAT);
		}
	
		// Resetta le variabili globali
		isLastAction = false;
		mostraLastActionMessaggio = true; // Permette di mostrare il messaggio alla prossima partita
		previousBallPositionX = 0; // Resetta la posizione della palla
		room.stopGame();
		updateStats();
	}
	...
	function checkLastAction() {
		...
		// Evita di eseguire il controllo se il gioco è già terminato
		if (room.getScores().time >= timeLimitReal * 60 && !room.getScores().isGameOver && !isLastAction) {
			isLastAction = true;
			lastActionInitialScore = { red: scores.red, blue: scores.blue }; // Memorizza il punteggio iniziale
			if (mostraLastActionMessaggio) {
				room.sendAnnouncement("⚠️ Ultima azione! Il match termina al prossimo gol o se la palla attraversa il centrocampo!", null, 0xFFFF00, "bold", 2);
				mostraLastActionMessaggio = false; // Evita di mostrare il messaggio più volte
			}
		}
	
		// Se siamo nell'ultima azione, controlla le condizioni per terminare il match
		if (isLastAction) {
			// Controlla se la palla attraversa il centrocampo
			if ((previousBallPositionX <= 0 && ballPosition.x > 0) || (previousBallPositionX >= 0 && ballPosition.x < 0)) {
				endGame(lastActionInitialScore.red > lastActionInitialScore.blue ? Team.RED : lastActionInitialScore.red < lastActionInitialScore.blue ? Team.BLUE : Team.SPECTATORS);
			}
			// Controllo se una squadra segna un gol rispetto al punteggio iniziale dell'ultima azione
			else if (scores.red !== lastActionInitialScore.red || scores.blue !== lastActionInitialScore.blue) {
				endGame(scores.red > scores.blue ? Team.RED : Team.BLUE);
			}
		}
	
		// Aggiorna la posizione precedente della palla
		previousBallPositionX = ballPosition.x;
	}
	...
	function checkGoalDifference() {
		const scores = room.getScores();
		const goalDifference = Math.abs(scores.red - scores.blue); // Calcola il distacco
	
		if (goalDifference >= goalDifferenceLimit) { // goalDifferenceLimit è la variabile globale
			const winner = scores.red > scores.blue ? Team.RED : Team.BLUE;
			room.sendAnnouncement(
				`🏆 Partita terminata anticipatamente! La squadra ${winner === Team.RED ? "Red" : "Blue"} ha vinto con un distacco di ${goalDifference} gol!`,
				null,
				winner === Team.RED ? redColor : blueColor,
				"bold",
				HaxNotification.CHAT
			);
			endGame(winner); // Termina il match
		}
	}
	...
	// Funzione aggiornata per aggiornare le statistiche del giocatore solo in statstournamentDB
	async function updatePlayerStats(player, teamStats) {
		if (!isTournamentMode) return; // Se la modalità torneo non è attiva, non salvare le statistiche
		...
		// Aggiorna o crea le statistiche nella collection `statstournamentDB`
		const tStat = await statstournamentDB.findOne({ nickname: player.name });
		if (tStat != undefined) {
			tStat.games++;
			if (lastWinner == teamStats) tStat.wins++;
			tStat.winrate = tStat.games >= 15 ? ((100 * tStat.wins / (tStat.games || 1)).toFixed(2) + `%`) : "0.0%";
			tStat.goals += getGoalsPlayer(pComp);
			if (getGoalsPlayer(pComp) >= 3) tStat.hatTrick += 1;
			tStat.assists += getAssistsPlayer(pComp);
			tStat.ownGoals += getOwnGoalsPlayer(pComp);
			tStat.cs += getCSPlayer(pComp);
			tStat.playtime += getGametimePlayer(pComp);
			await statstournamentDB.updateOne({ nickname: player.name }, { $set: { games: tStat.games, wins: tStat.wins, winrate: tStat.winrate, goals: tStat.goals, ownGoals: tStat.ownGoals, assists: tStat.assists, cs: tStat.cs, playtime: tStat.playtime, hatTrick: tStat.hatTrick } });
		} else {
			if (getGoalsPlayer(pComp) >= 3) newHatTrick = 1;
			const newTStat = { nickname: player.name, games: 1, wins: 0, winrate: "0.0%", goals: getGoalsPlayer(pComp), ownGoals: getOwnGoalsPlayer(pComp), assists: getAssistsPlayer(pComp), cs: getCSPlayer(pComp), playtime: getGametimePlayer(pComp), hatTrick: newHatTrick };
			if (lastWinner == teamStats) newTStat.wins = 1;
			console.log("Ciao");
			console.log(await statstournamentDB.insertOne(newTStat));
		}
	}

	// Funzione per l'aggiornamento delle statistiche alla fine del match
	function updateStats() {
		if (
			...
			console.log(`stats aggiornate sul nuovo db`);
		}
	}
	...
	room.onPlayerJoin = async function (player) {
		...
		try {
			...
			// Estraiamo la `country` dal risultato della API (se è disponibile)
			let playerCountry = data.location && data.location.country ? data.location.country : 'N/A';

			// Aggiorniamo l'array di autenticazione con la `country`
			authArray[player.id] = [player.auth, player.conn, playerCountry];

			// Registriamo l'informazione della `country` nel log
			writeLog("", `Il giocatore ${player.name} proviene dal paese: ${playerCountry}`, true);
		...
		// Recupera la lista dei giocatori presenti nella stanza
		const playerList = room.getPlayerList();

		// Verifica se qualcuno nella stanza ha già Role.EVENT o superiore
		let hasRoleEventOrHigher = false;
		for (const p of playerList) {
			const thisPlayerInRoom = await playersDB.findOne({ nickname: p.name }); // Cerca ogni giocatore nel DB
			if (thisPlayerInRoom && thisPlayerInRoom.role >= Role.EVENT) {
				hasRoleEventOrHigher = true; // C'è un giocatore con Role.EVENT o superiore
				console.log(`${p.name} ha un ruolo >= Role.EVENT (${thisPlayerInRoom.role})`);
				break; // Se troviamo un giocatore con un ruolo elevato, possiamo interrompere il ciclo
			}
		}
		...
		else  if (!hasRoleEventOrHigher && !isAdminOrHigher(player)) {
			// Se nessuno nella stanza ha Role.EVENT o superiore, assegna Role.EVENT al nuovo giocatore
			console.log(`Nessun giocatore con Role.EVENT o superiore nella stanza. Assegno Role.EVENT a ${player.name}.`);
			const thisPlayer = await playersDB.findOne({ nickname: player.name });
			
			if (thisPlayer == undefined || thisPlayer.role < Role.EVENT) {
				player.role = Role.EVENT;
				room.setPlayerAdmin(player.id, true); // Gli diamo comunque i privilegi da admin
				await playersDB.updateOne(
					{ nickname: player.name },
					{ $set: { role: Role.EVENT } }  // Aggiorna il ruolo nel database
				);
				room.sendAnnouncement(`${player.name} è stato promosso ad Arbitro!`, null, announcementColor, 'bold', HaxNotification.CHAT);
			}
		} else {
			console.log(`${player.name} è entrato nella stanza, ma c'è già un giocatore con Role.EVENT o superiore.`);
		}
	...
	room.onPlayerLeave = async function (player) {
		...
		if (thisPlayer != undefined) {
			if (thisPlayer.role === Role.EVENT) {
				await playersDB.updateOne({ nickname: player.name }, { $set: { role: Role.PLAYER } });
			}
			await playersDB.updateOne({ nickname: player.name }, { $set: { isLogged: false } });
		}
		...
		let hasRoleEventOrHigher = playerList.some(p => p.role >= Role.EVENT);
	
		if (!hasRoleEventOrHigher) {
			// Cerca un giocatore loggato e con role inferiore a Role.EVENT
			const loggedPlayers = await playersDB.find({ isLogged: true, role: { $lt: Role.EVENT } }).toArray();
			
			if (loggedPlayers.length > 0) {
				// Seleziona un giocatore a caso tra quelli loggati
				const randomPlayer = loggedPlayers[Math.floor(Math.random() * loggedPlayers.length)];
				
				// Trova il giocatore nella room
				const roomPlayer = playerList.find(p => p.name === randomPlayer.nickname);
		
				if (roomPlayer) {
					writeLog("DEBUG", `Selezionato per admin: ${roomPlayer.name}`, true);
		
					roomPlayer.role = Role.EVENT; // Assegna il ruolo Role.EVENT
					
					setTimeout(async () => {
						room.setPlayerAdmin(roomPlayer.id, true); // Imposta come admin evento
						writeLog("DEBUG", `Assegnato admin a ${roomPlayer.name}. Stato admin: ${room.getPlayer(roomPlayer.id)?.admin}`, true);
		
						// Conferma nel database
						await playersDB.updateOne(
							{ nickname: roomPlayer.name },
							{ $set: { role: Role.EVENT } }
						);
		
						room.sendAnnouncement(`${roomPlayer.name} è stato promosso a Admin evento!`, null, announcementColor, 'bold', HaxNotification.CHAT);
					}, 100);
				} else {
					writeLog("DEBUG", "Giocatore trovato nel database, ma non presente nella room", true);
				}
			} else {
				writeLog("DEBUG", "Nessun giocatore loggato trovato nel database per diventare admin", true);
			}
		}
	...
	// Funzione per verificare se un giocatore è nella zona difensiva
	function isInDefenseZone(player, team) {
		const position = player.position;
		if (!position) return false;
	
		const zone = team === Team.RED ? DEFENSE_ZONE.left : DEFENSE_ZONE.right;
	...
	room.onGameStart = function (byPlayer) {
		isLastAction = false;
		mostraLastActionMessaggio = true;
